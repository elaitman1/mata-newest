...
import { jobNumber } from '../../Redux/actions'
...
export default class StartJob extends Component {
  ...
  //     foundJob = this.state.jobs.find(job=>{
  //
  //       return job.jobNum === this.props.currentJob
  //     })
  //   }
  //   console.log(foundJob)
  //   console.log(this.state.totalJobs)
  //   if(this.props.currentJob > 1){
  //     let jobsArray = this.state.jobs
  //     jobsArray.push(
  //       {jobNum:this.props.currentJob,
  //        inputValues:
  //         {
  //           jobNumber: "",
  //           partNumber: "",
  ...
  //     )
  //
  //   await this.setState(state => (state.jobs = jobsArray, state.currentJob = this.props.currentJob,state.totalJobs = state.totalJobs + 1, state))
  // }
  //     if(this.props.jobNumber !== "" && this.props.partNumber !== ""){
  //       this.setState(state => (state.jobs[this.state.currentJob - 1].inputValues.jobNumber = this.props.jobNumber, state.jobs[this.state.currentJob - 1].inputValues.partNumber = this.props.partNumber, state))
  //     }else if(this.props.partNumber !== ""){
  //       this.setState(state => (state.jobs[this.state.currentJob - 1].inputValues.partNumber = this.props.partNumber, state))
  //     }else if(this.props.jobNumber !== ""){
  //       this.setState(state => (state.jobs[this.state.currentJob - 1].inputValues.jobNumber = this.props.jobNumber, state))
  //     }
    // }
  ...
  update = (type, jobNum, value) => {
    ...
    this.setState({ jobs: newJobs, inputIndicator:"" });
  };
  ...
  toggleCamera = (e) => {
    ...
    // this.props.toggleCamera(inputIndicator, this.state.currentJob);
    this.setState({showCamera:!this.state.showCamera, inputIndicator:inputIndicator})
  };
      ...
      return (
        <div>
          ...
          {this.state.showCamera ? (
            <Camera update={this.update} toggleCamera={this.toggleCamera} />
          ) : (
